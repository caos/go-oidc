...
// Source: github.com/caos/go-oidc/pkg/oidc (interfaces: KeySet)
...
func (m *MockKeySet) VerifySignature(arg0 context.Context, arg1 *go_jose_v2.JSONWebSignature) ([]byte, error) {
	m.ctrl.T.Helper()
